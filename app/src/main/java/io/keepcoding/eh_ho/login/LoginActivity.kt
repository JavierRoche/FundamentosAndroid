...
// Los InteractionListener de cada fragmento nos permite capturar en la actividad los eventos abstractos definidos en los protocolos de cada fragmento
class LoginActivity: AppCompatActivity(), SignInFragment.SignInInteractionListener,
    ...
    override fun onSignIn(signInModel: SignInModel) {
        ...
        enableLoading()
        // Ejecutamos la peticion al server pasando el contexto general de la app, el modelo de datos de user y una lambda que le diga que hacer en caso de exito en el login
        UserRepo.signIn(
